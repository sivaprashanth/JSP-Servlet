...
p {font-family:Times;font-size:22px;font-style:normal;font-weight:normal;color:000000;}
    ...
    <br>
    <center><h2 style="font-size:50px">Vendor Details</h2></center> 
...
<table id="cssTable">
  <tr>
    <th align="center" valign="middle">Vendor ID</th>
    ...
    <th align="center" valign="middle">Vendor Name</th>
      ...
      <th align="center" valign="middle">Web Address</th>
       <th align="center" valign="middle">Certificate Issue Date</th>
      <th align="center" valign="middle">Certificate Valid Date</th>
       <th align="center" valign="middle">Employee Count</th>
      <th align="center" valign="middle">Customer Count</th>
       <th align="center" valign="middle">Year of Establishment</th>
       <th align="center" valign="middle">Year of Survival</th>
...
while(r.next())
{
      ...
      out.println("<td align='center' valign='middle'>"+r.getString(16)+"</td></tr>");  
}
co.close();
%>
</table>
