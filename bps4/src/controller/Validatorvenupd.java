...
import model.Pojodbvenupd;

/**
 * Servlet implementation class Validator
 */
public class Validatorvenupd extends HttpServlet {
	...
	IOException 
	{
		...
		if(!(l.isEmpty()))
		{
			RequestDispatcher r=request.getRequestDispatcher("designvenupd.jsp");
		...
		else
		{
			...
			try 
			{
				...
				{
					RequestDispatcher rq=request.getRequestDispatcher("designvenupdsuc.jsp");
